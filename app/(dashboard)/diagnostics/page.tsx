  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-3">
        ...
        {["waiting", "active", "delayed", "failed"].map((key) => (
          <div key={key} className="panel rounded p-4 sm:p-5">
            <p className="text-xs font-semibold uppercase text-muted">
              Fila {key === "waiting" ? "aguardando" : key === "active" ? "ativa" : key === "delayed" ? "atrasada" : "falha"}
            </p>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Section title="Falhas e DMs Ignoradas nas Campanhas">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Section title="Falhas na Renovação de Token">
